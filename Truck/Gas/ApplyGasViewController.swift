...
class ApplyGasViewController: BaseViewController {
    ...
    func requestDrivers() {
        Service.shared.listDriver(vehicleId: <#T##String#>)
    }
...
extension ApplyGasViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .carInfo, .driverInfo:
            ...
            guard let vehicles = self.vehicles else {
                return cell
            }
            if type == .carInfo {
